...
const experienceHighlights = [
  ...
  'Modernized login flows by moving credential management to a centralized authentication platform and adding MFA. A Kafka consumer I built for authentication and credential events cut production issue diagnosis time by more than 75%.',
